...
<div class="banner-wrapper">
    <section class="banner-two banner-carousel__one no-dots owl-theme owl-carousel">
        ...
        <div class="banner-two__slide banner-two__slide-two" style="background-image: url(ladun/home_asset/img/slide_home/2.png);">
            <div class="container">
                <div class="row no-gutters">
                    <div class="col-xl-12">
                        <p class="banner-two__tag-line">High Quality University</p><!-- /.banner-two__tag-line -->
    ...
    <div class="banner-one__cta">
        ...
        <div class="banner-one__cta-title">
            <h3 class="banner-one__cta-text"><a href="{{ $penmaru -> nilai }}">Informasi pendaftaran mahasiswa baru</a></h3><!-- /.banner-one__cta-text -->
                ...
                <div class="about-two__content">
                    <div class="block-title text-left">
                        <h2 class="block-title__title">Welcome to <br>
                            UIN SU Medan</h2><!-- /.block-title__title -->
                    </div><!-- /.block-title -->
                    <p class="about-two__text">Universitas yang mengintegrasikan nilai Islam dan ilmu pengetahuan. Memadukan IPTEK
                        dan IMTAK untuk mempersiapkan lulusan tangguh menghadapi jaman</p><!-- /.about-two__text -->
...
<section class="course-one__top-title home-one">
    <div class="container">
        <div class="block-title mb-0">
            <h2 class="block-title__title">Uinsu Today</h2><!-- /.block-title__title -->
        </div><!-- /.block-title -->
    </div><!-- /.container -->
            ...
            <div class="col-lg-4">
                <div class="blog-one__single">
                    <div class="blog-one__image">
                        <img src="https://uinsu.ac.id/wp-content/uploads/2020/07/kunker-komisi-E1-1160x773.jpg" alt="">
                    ...
                    <div class="blog-one__content text-center">
                        ...
                        <h2 class="blog-one__title"><a href="news-details.html">Komisi E DPRD Sumut Kunker ke Kampus IV UIN SU Tuntungan</a>
                        </h2><!-- /.blog-one__title -->
                        <p class="blog-one__text">Rektor UIN SU Prof Dr Saidurrahman MAg diabadikan bersama rombongan Komisi E DPRD Sumut, yang dipimpin Dimas Tri Adji</p><!-- /.blog-one__text -->
...
<section class="brand-two ">
    <div class="container">
        ...
        <div class="brand-one__carousel owl-carousel owl-theme">
            <div class="item">
                <img src="https://www.ebunga.com/assets/themes/ebunga/images/ebunga-seller-min.png" alt="">
            </div><!-- /.item -->
